...
All data used is included in folder called ‘data’. Most are in the form of CSV files, except the 2013 Crash Report data I received from Professor Miller, which she parsed into a pipe-separated txt file.  The NHTSA FARS data was only as SAS datasets, so I downloaded SAS University Edition and created a virtual machine using VirtualBox and converted it into CSV files which I could save on my local machine.
