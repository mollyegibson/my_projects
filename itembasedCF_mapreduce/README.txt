...
Then you’ll have .class files in the same job0 directory. 
...
This hadoop jar command names the JAR file to use (job0.jar), the driver’s class (Job0Driver) and the HDFS input/output directories. Then the output will be in job0_output1/part-r-00000.  
